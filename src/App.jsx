    ...
    <>
      ...
      <>
        <Router>
          ...
          <ScrollToTop />
          <Routes>
            <Route path="/" element={<Home data={gamesData} selectedGame={selectedGame} setSGame={setSGame} vipAccess={false}  checkout={appData.vipCheckout} communityLink={appData.community}/>} />
            <Route path="/modevip" element={<Home data={gamesData} selectedGame={selectedGame} setSGame={setSGame} vipAccess={true} setVipAccess={setVipAccess}  checkout={appData.vipCheckout} communityLink={appData.community}/>} />
            ...
            />} />
            <Route path='/bonus' element={<Bonus inicio={inicio} affLink={affLink}
 />} />
